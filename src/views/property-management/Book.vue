        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="16">
            <a-form-item style="float:right">
              <a-button type="primary" @click="handleAdd('2')">广告位预定</a-button>
              <a-button type="primary" @click="handleAdd('1')" style="margin-left: 8px">会议室预定</a-button>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
  ...
  export default {
    ...
    data() {
      return {
        ...
        types: {
          type: [
            { name: 'advert', label: '广告位' },
            { name: 'meeting', label: '会议室' },
          ]
        },
        // Query
        queryParam: {
