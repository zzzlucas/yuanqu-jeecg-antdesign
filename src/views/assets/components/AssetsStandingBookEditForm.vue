<template>
  <a-drawer
    ...
    <a-form
      ...
      <a-row>
        <a-col :xl="24">
          <a-form-item label="登记入库信息表" :label-col="gridOptions.formItemFullRow.label" :wrapper-col="gridOptions.formItemFullRow.value">
...
<script>
  ...
  export default {
    mixins: [
      FormEditDrawerMixin('assets-standing-book'),
    ],
    data() {
      return {
      }
