  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'projectId','projectName','projectType','agentPerson','agentTel','belongSubject','investorValue','custId','getLandBuildingAddress','mainBuildingContent','areaPerformance','mainMaterial','materialCost','mainProduct','productOutput','waterElec','greenFire','allUseArea','newUseArea','rentBuildArea','industrySectorValue','isTalentProject','gainArea','annualProductionValue','annualTaxes','status','applyReason','projectTechnologyFlow','importance','projectManager','auditStatus','parkId','version','createUserName','updateUserName'))
		  //时间格式化
          this.form.setFieldsValue({buildingBeginDate:this.model.buildingBeginDate?moment(this.model.buildingBeginDate):null})
          this.form.setFieldsValue({buildingEndDate:this.model.buildingEndDate?moment(this.model.buildingEndDate):null})
        });
